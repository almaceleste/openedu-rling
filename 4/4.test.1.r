...
x <- read_csv('./data.japanese.vocal.tract.length.csv')
# x <- read_csv('./data.japanese.vocal.tract.length_fake_100.csv')
# x <- read_csv('./data.japanese.vocal.tract.length_fake_1000.csv')
